...
//74.//////////////////////////////////////////////////////////////////////////////////////////////// 
//DOM: botón volver móvil (history back)
//21.10.2013 GPS

function volver(_document){

 var _url = _document.referrer;
 _posicion_login = _url.indexOf("login.php");
 
 if(_posicion_login==-1);
   history.back();
...
function mostrarLocaliz(loc){

  var _tuLatitud = loc.coords.latitude;
  var _tuLongitud = loc.coords.longitude;
...
function numeros(e){ // 1
  ...
  _tecla = (document.all) ? e.keyCode : e.which; 
  if (_tecla==8 || _tecla==0){
    return true; 
  }
	
  _patron = /[0123456789]/; 
  _te = String.fromCharCode(_tecla); 
  
return _patron.test(_te); 
}

...
function inicializar_google_maps(mobile,server,id_supervisor,tipo_key_id,key_id,lat,long,filtros){
  ...
  if(ventana=="mapa_sucursales" || ventana=="mapa_sucursales_di"){
    ...
    cadena_parametros = "tipo_key_id="+tipo_key_id+"&cod_interno="+key_id+"&id_canal="+filtros+"&ventana="+ventana;  
    ...
    loadurl_xml("mapa/action_listar_sucursales.php",cadena_parametros,triggered_lista_xml);
  } 
